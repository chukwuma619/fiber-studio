...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::assets::get_assets_page,
            ...
            commands::rebalance::rebalance_channel,
            ...
            commands::payments::get_preflight_snapshot,
            ...
            commands::cch::update_cch_rpc_url,
            commands::cch::cch_send_btc,
            commands::cch::cch_receive_btc,
            commands::cch::cch_get_order,
